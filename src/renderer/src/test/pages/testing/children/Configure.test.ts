...
describe('configure test page', () => {
    it('shows duration setting for "Simulate" mode only', async () => {
        ...
        const simulateRadio = getByTestId('test-delivery-mode-simulate').querySelector(
            'input',
        ) as HTMLInputElement;
        const prepareRadio = getByTestId('test-delivery-mode-prepare').querySelector(
            'input',
        ) as HTMLInputElement;
    ...
    it('shows question filters only for randomized ordering', async () => {
        ...
        const originalRadio = getByTestId('question-ordering-original').querySelector('input')!;
        const randomRadio = getByTestId('question-ordering-random').querySelector('input')!;
        const randomBySectionRadio = getByTestId(
            'question-ordering-random-by-section',
        ).querySelector('input')!;
